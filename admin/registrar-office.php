...
if (isset($_SESSION['admin_id']) && isset($_SESSION['role'])) {
    ...
    if ($_SESSION['role'] == 'Admin') {
        include "../DB_connection.php"; // Assuming this file contains database connection and function definitions
        
        // Include registrar-office.php assuming it's in admin/data directory
        include "../admin/data/registrar-office.php";
        
        // Assuming getAllR_users() retrieves registered users from database
        $r_users = getAllR_users($conn); // $conn should be your database connection object
?>
